...
::: {.column width="45%"}
![A population pyramid, with each bar representing an age class and the width of the bar representing the population size in that age class. Source: [flexbooks.ck12.org](https://flexbooks.ck12.org/cbook/ck-12-biology-flexbook-2.0/section/6.18/primary/lesson/population-structure-bio/) / Douglass Wilkin and Jean Brainard](images/clipboard-2282892022.png)
:::
:::::
...
::: {.column width="45%"}
![[2travellingacrosstime.com](https://2travellingacrosstime.com/2023/08/19/types-of-population-pyramids/)](images/types-of-population-pyramids.png)
:::
:::::
...
::: {.column width="45%"}
![[skikshabhumi.blogspot.com](https://shikshabhumi.blogspot.com/2020/05/concept-of-population-structureage-sex.html)](images/clipboard-1010679472.png)
:::
:::::
...
::: {.column width="45%"}
![[weforum.org](https://www.weforum.org/stories/2023/06/visual-guide-global-population-pyramids-demographics/)](images/clipboard-68205917.png)
:::
:::::
...
::: {.column width="45%"}
![OWID](images/Demographic-Transition.png)
:::
:::::
...
::: {.column width="45%"}
![The age structure of populations varies widely across countries. [OWID](https://ourworldindata.org/data-insights/the-age-structure-of-populations-varies-widely-across-countries) / Fiona Spooner](images/age-group-with-the-largest-population-mobile.png)
:::
:::::
...
::: {.column width="50%"}
![[OWID](https://ourworldindata.org/age-structure)](images/Population-Pyramid-1950-to-2100.jpg)
:::
:::::
...
-   [Dependency ratio]{.keyword}: Number of dependents relative to working-age adults
...
::: {.column width="45%"}
![Old-age dependency ratio, 1950 to 2023. [OWID](https://ourworldindata.org/grapher/age-dependency-ratio-old?tab=line&country=JPN~OWID_WRL~FIN~OWID_AFR~USA~CHN~IND).](images/age-dependency-ratio-old.png)
:::
:::::
...
:::::: {.column width="45%"}
![[Wikipedia](https://en.wikipedia.org/wiki/Demographics_of_Japan)](images/Japan_population_pyramid_10.01.2019.png){width="682"}

::::: columns
::: {.column width="50%"}
![[OWID](!%5BOWID%5D(images/age-dependency-ratio-old-mobile.png)%7Bfig-align=%22center%22%20width=%22300%22%7D)](images/japan-deaths-double-births.png){fig-align="center" width="300"}
:::

::: {.column width="50%"}
![[OWID](https://ourworldindata.org/data-insights/japan-has-the-highest-ratio-of-elderly-people-relative-to-working-age-people-globally)](images/age-dependency-ratio-old-mobile.png){fig-align="center" width="300"}
:::
:::::
::::::
::::::::
...
::: {.column width="45%"}
![](images/clipboard-1316730974.png){fig-align="center" width="445"}

![Source: [Africa’s Urbanisation Dynamics 2025](https://www.oecd.org/content/dam/oecd/en/publications/reports/2025/03/africa-s-urbanisation-dynamics-2025_005a8aa0/2a47845c-en.pdf)](images/clipboard-843275789.png){fig-align="center" width="448"}
:::
:::::
...
::::: columns
::: {.column width="55%"}
-   [Demographic momentum]{.keyword}: continued population growth after fertility declines
...
::: {.column width="45%"}
![](images/Population-momentum.png){width="487"}
:::
:::::
...
::: {.column width="45%"}
![](images/population-by-age-group-with-projections.png)
:::
:::::
...
::: {.column width="45%"}
![[Wikipedia](https://en.wikipedia.org/wiki/List_of_countries_by_energy_consumption_per_capita)](images/clipboard-2713514748.png)
:::
:::::
...
![](images/clipboard-356259384.png){width="498"}
:::

::: {.column width="45%"}
![](images/share-global-cumulative-co2-including-land.png)
:::
:::::
