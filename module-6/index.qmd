...
::: {.column width="50%"}
![Pesticide application can artificially select for resistant pests. In this diagram, the first generation happens to have an insect with a heightened resistance to a pesticide (red) After pesticide application, its descendants represent a larger proportion of the population, because sensitive pests (white) have been selectively killed. After repeated applications, resistant pests may comprise the majority of the population. Image: Delidot. GFDL, cc by sa 3.0](images/clipboard-3685865045.png)
:::
:::::
...
::: {.column width="50%"}
![](https://elkmoundseed.com/cdn/shop/files/EMS-Remedy_5c372581-f32d-4084-8883-c26fed2ffb1f.png)
:::
:::::
